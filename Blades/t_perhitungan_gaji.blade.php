...
<div class="flex flex-col gap-2">
          <label
            ...
            for="is_tunjangan_for_click"
            >Tunjangan & Potongan :</label
          >
          <div class="flex w-40">
            <div class="flex-auto">
            ...
            <div class="flex-auto">
              <input
                ...
                type="checkbox"
                :class="{'after:bg-gray-500': values.is_tunjangan === false}"
                role="switch"
                id="is_tunjangan_for_click"
                :disabled="!actionText"
                v-model="values.is_tunjangan"
                />
            </div>
            <div class="flex-auto">
