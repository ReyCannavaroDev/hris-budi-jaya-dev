...
class mKaryDetKartuTest extends TestCase
{
    ...
    public function testReadingData()
    {
        ...
        $this->call('GET', '/operation/m_kary_det_kartu', $payload);
    ...
    public function testCreatingData()
    {
        ...
        $this->call('POST', '/operation/m_kary_det_kartu', $payload);
        ...
        $this->seeInDatabase('m_kary_det_kartu', array_filter($payload, function($dt){
            return !is_array($dt);
        } ));
    }
}