...
class mKaryDetPembTest extends TestCase
{
    ...
    public function testReadingData()
    {
        ...
        $this->call('GET', '/operation/m_kary_det_pemb', $payload);
    ...
    public function testCreatingData()
    {
        ...
        $this->call('POST', '/operation/m_kary_det_pemb', $payload);
        ...
        $this->seeInDatabase('m_kary_det_pemb', array_filter($payload, function($dt){
            return !is_array($dt);
        } ));
    }
}